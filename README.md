...
Preventing users who aren't logged in from accessing parts of the website.

1. What does bcrypt do to help us store passwords in a secure manner.

It hashes the password and includes the hash.

1. What does bcrypt do to slow down attackers?

It hashes the password many times, making it slower.
